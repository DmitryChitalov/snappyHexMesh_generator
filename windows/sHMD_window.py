...
class shmd_window_class(QtGui.QWidget):
	def __init__(self, parent, par):
		...
		if layers_visible == True and os.path.exists(layers_path):
	...
	def on_castellatedMC_1_btnSave_clicked(self):
		...
		if len(cMC_obj) == 5:
			...
			if castellatedMC_visible == True:
				...
				or rR_level_single_edit_old_mas != rR_level_single_edit_new_mas or rR_level_multi_edit_old_mas != rR_level_multi_edit_new_mas:
